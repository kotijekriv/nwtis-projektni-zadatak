package org.foi.nwtis.pradic1.aplikacija_3.filteri;
...
@WebFilter(filterName = "KontrolaPristupa", urlPatterns = {"/mvc/korisnik/administracija", "/mvc/korisnik/komanda", 
    "/mvc/korisnik/popisKorisnikaPrati", "/mvc/korisnik/administracijaAerodroma", "/mvc/korisnik/odjava"},
...
public class KontrolaPristupa implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (sesija == null || sesija.getAttribute("korisnik") == null) {
            RequestDispatcher rd = request.getRequestDispatcher("/mvc/korisnik/prijavaKorisnika");
