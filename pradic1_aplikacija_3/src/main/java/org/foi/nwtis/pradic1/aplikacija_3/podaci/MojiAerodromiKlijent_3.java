 ...
 */
package org.foi.nwtis.pradic1.aplikacija_3.podaci;
...
public class MojiAerodromiKlijent_3 {
     ...
     */
    public <T> T dajKorisnikoveAerodrome(Class<T> responseType, String korisnik, String lozinka) throws jakarta.ws.rs.ClientErrorException {
     ...
     * @param lozinka header parameter[REQUIRED]
     */
    public <T> T dodajPracenje(Object requestEntity, Class<T> responseType, String korisnik, String lozinka) throws jakarta.ws.rs.ClientErrorException {
