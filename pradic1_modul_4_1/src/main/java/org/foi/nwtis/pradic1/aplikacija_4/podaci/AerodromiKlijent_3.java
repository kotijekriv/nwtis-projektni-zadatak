...
/**
 * Jersey REST client generated for REST resource:aerodromi [aerodromi/{icao}/letovi]<br>
 * USAGE:
 * <pre>
 *        AerodromiKlijent_3 client = new AerodromiKlijent_3();
 ...
 * @author NWTiS_4
 */
public class AerodromiKlijent_3 {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8084/pradic1_aplikacija_2/rest/";

    public AerodromiKlijent_3(String icao) {
        client = jakarta.ws.rs.client.ClientBuilder.newClient();
        String resourcePath = java.text.MessageFormat.format("aerodromi/{0}/letovi", new Object[]{icao});
     ...
     */
    public <T> T dohvatiBrojLetovaAerodroma(Class<T> responseType, String korisnik, String lozinka) throws ClientErrorException {
